...
2. Логику работы необходимо отделить от обработки входных данных и вывода результата и выделить в отдельный файл.
  ...
  *Note: При линковке важен порядок, в котором указываются входные файлы, так как линкер работает в один проход.
  Если файл bc.o использует файл calc.o, то bc.o должен идти после calc.o.*
