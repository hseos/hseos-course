...
#include <unistd.h>
int pause(void);
Возвращает значение –1 с кодом ошибки EINTRв переменной errno
```

## Ссылки

- [Лекция 15](https://github.com/hseos/hseos-course/blob/master/00-lectures/os15.pdf)
- [Лекция 16] (https://github.com/hseos/hseos-course/blob/master/00-lectures/os16.pdf)
- [Примеры лекции 16] (https://github.com/hseos/hseos-course/tree/master/00-lectures/16-signal)
