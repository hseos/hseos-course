...
Возникает дилема: как выполнить "присваивание", не нарушая вышеописанных принципов *владения*
ресурсами?
...
`a`, но при этом, значение в `a` становится не валидным.

Что происходит во время перемещения, и как происходит инвалидация премещаемой переменной,
