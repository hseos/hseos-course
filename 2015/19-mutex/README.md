...
[Лекция про синхронизацию](https://github.com/hseos/hseos-course/blob/master/00-lectures/os19.pdf)
...
Data race - это ситуация в программе, когда выполнены два условия:
 1. Два потока одновременно работают с одной и той же переменной.
 2. Один из них пишет в эту переменную.
...
Пример организации взаимодействия нитей с помощью условных переменных (барьер нитей) приведен на лекции
[barrier.cpp](https://github.com/hseos/hseos-course/blob/master/00-lectures/19-mutex/barrier.cpp)
